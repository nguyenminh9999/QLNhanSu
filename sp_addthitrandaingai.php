...
<table width="100%" border="0">
    ...
    <td>
        ...
        <a href="tv_danhmucthitrandaingai.php" class="blink-link"><h3>Quay lại trang trước</h3></a>
    </td>
      <td width="2%">&nbsp;</td>
      <td width="10%">&nbsp;</td>
      <td width="10%">&nbsp;</td>
...
<form id="form1" name="form1" method="post" action="sp_process_addthitrandaingai.php" onsubmit="return handleFormSubmit()">
...
<script>
  function handleFormSubmit() {
    // Thêm mã JavaScript để hiển thị cửa sổ thông báo khi thành công
    // Đây là ví dụ đơn giản, bạn có thể sử dụng các thư viện hoặc phương pháp phức tạp hơn nếu cần.
    alert("Thêm thành công!"); // Thông báo đơn giản, có thể thay thế bằng các loại thông báo khác như modal, toast, v.v.
