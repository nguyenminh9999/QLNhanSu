...
<table width="100%" border="0">
    ...
    <td>
        ...
        <a href="tv_danhmucxatruongkhanh.php" class="blink-link"><h3>Quay lại trang trước</h3></a>
    </td>
      <td width="2%">&nbsp;</td>
      <td width="10%">&nbsp;</td>
      <td width="10%">&nbsp;</td>
...
<form id="form1" name="form1" method="post" action="sp_process_addxatruongkhanh.php">
