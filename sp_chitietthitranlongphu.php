...
{
$macb = $_GET['MaCB'];
$str = "select * from nhansuthitranlongphu where MaCB='{$macb}'";
$kq = mysql_query($str,$link);
	...
	else
	{
		...
		<?php
		header("location:tv_danhmucthitranlongphu.php");
	}
}
?>
...
<table width="100%" border="0">
  <tr>
    <td width="42%" height="40"><div align="center">Mã cán bộ :<?php echo isset($i[0]) ? $i[0] : ''; ?></div></td>
    <td width="58%">&nbsp;</td>
  </tr>
  <tr>
