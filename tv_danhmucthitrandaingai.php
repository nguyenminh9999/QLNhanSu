...
$str = "SELECT `MaCB`, `Hoten`, `Ngaysinh`, `Gioitinh`, `Quoctich`, `Dantoc`, `Tongiao`, `Quequan`, `Giaoducphothong`, `Chuyenmonnghiepvu`, `Tuoi`, `Lyluanchinhtri`, `Ngoaingu`, `Nghenghiepchucvu`, `Noicongtac`, `Ngayvaodang`, `Tinhtrang`, `Ghichu` FROM nhansuthitrandaingai"; 
...
if (isset($_GET['quequan'])) {
    ...
    if ($quequan_selected == 'all') {
        ...
        $str = "SELECT * FROM nhansuthitrandaingai";
    } else {
        // Hiển thị theo quê quán được chọn
        $str = "SELECT * FROM nhansuthitrandaingai WHERE Quequan = '$quequan_selected'";
    }
    $kq = mysql_query($str, $link);
    $num_row = mysql_num_rows($kq);
}
...
if (isset($_GET['tinhtrang'])) {
    ...
    if ($tinhtrang_selected == 'all') {
        ...
        $str = "SELECT * FROM nhansuthitrandaingai WHERE Tinhtrang = 'Miễn nhiệm'";
    } elseif ($tinhtrang_selected == 'bainhiem') {
        // Hiển thị những nhân viên có tình trạng là "Bãi nhiệm"
        $str = "SELECT * FROM nhansuthitrandaingai WHERE Tinhtrang = 'Bãi nhiệm'";
    } else {
        // Hiển thị theo tình trạng được chọn
        $str = "SELECT * FROM nhansuthitrandaingai WHERE Tinhtrang = '$tinhtrang_selected'";
    }
    $kq = mysql_query($str, $link);
    $num_row = mysql_num_rows($kq);
}
...
if (isset($_GET['dantoc'])) {
    ...
    if ($dantoc_selected == 'all') {
        ...
        $str = "SELECT * FROM nhansuthitrandaingai WHERE Dantoc = '$dantoc_selected'";
    }
    $kq = mysql_query($str, $link);
    $num_row = mysql_num_rows($kq);
}
...
if (isset($_GET['gioitinh'])) {
    ...
    if ($gioitinh_selected == 'all') {
        ...
        $str = "SELECT * FROM nhansuthitrandaingai WHERE Gioitinh = '$gioitinh_selected'";
    }
    $kq = mysql_query($str, $link);
    $num_row = mysql_num_rows($kq);
}
...
if (isset($_GET['tongiao'])) {
    ...
    if ($tongiao_selected == 'all') {
        ...
        $str = "SELECT * FROM nhansuthitrandaingai WHERE Tongiao = '$tongiao_selected'";
    }
    $kq = mysql_query($str, $link);
    $num_row = mysql_num_rows($kq);
}
...
if (isset($_GET['chuyenmon'])) {
    ...
    if ($chuyenmon_selected == 'all') {
        ...
        $str = "SELECT * FROM nhansuthitrandaingai WHERE Chuyenmonnghiepvu = '$chuyenmon_selected'";
    }
    $kq = mysql_query($str, $link);
    $num_row = mysql_num_rows($kq);
}
...
if (isset($_GET['tuoi'])) {
    ...
    if ($tuoi_selected == '18_70') {
        ...
        $str = "SELECT * FROM nhansuthitrandaingai WHERE Tuoi BETWEEN 18 AND 70";
    } elseif ($tuoi_selected == '20_35') {
        // Hiển thị cán bộ trong độ tuổi từ 20 đến 35
        $str = "SELECT * FROM nhansuthitrandaingai WHERE Tuoi BETWEEN 20 AND 35";
    } elseif ($tuoi_selected == '35_45') {
        // Hiển thị cán bộ trong độ tuổi từ trên 35 đến dưới 45
        $str = "SELECT * FROM nhansuthitrandaingai WHERE Tuoi BETWEEN 35 AND 45";
    } elseif ($tuoi_selected == '45_62') {
        // Hiển thị cán bộ trong độ tuổi từ trên 45 đến dưới 62
        $str = "SELECT * FROM nhansuthitrandaingai WHERE Tuoi BETWEEN 45 AND 62";
    } elseif ($tuoi_selected == '62_tren') {
        // Hiển thị cán bộ trong độ tuổi từ 62 trở lên
        $str = "SELECT * FROM nhansuthitrandaingai WHERE Tuoi >= 62";
    } else {
...
if (isset($_GET['lyluanchinhtri'])) {
    ...
    if ($lyluanchinhtri_selected == 'all') {
        ...
        $str = "SELECT * FROM nhansuthitrandaingai WHERE Lyluanchinhtri = '$lyluanchinhtri_selected'";
    }
    $kq = mysql_query($str, $link);
    $num_row = mysql_num_rows($kq);
}
...
if (isset($_GET['ngoaingu'])) {
    ...
    if ($ngoaingu_selected == 'all') {
        ...
        $str = "SELECT * FROM nhansuthitrandaingai WHERE Ngoaingu = '$ngoaingu_selected'";
    }
    $kq = mysql_query($str, $link);
    $num_row = mysql_num_rows($kq);
}
...
<a href="xathitran.php" id="back-to-previous-page-button"><h2 class="navigation-link">Quay lại trang trước</h2></a>
  ...
  <a href="sp_addthitrandaingai.php"><span><h2>Thêm cán bộ mới</h2></span></a>
</div>';
...
<div align="center">
  ...
  <form method="get" action="tv_danhmucthitrandaingai.php">
...
<div id="quequan" class="center hidden">
  ...
  <ul>
    <li><a href='tv_danhmucthitrandaingai.php?quequan=all' class='menu-link' id='quequan_all'>Tất cả (<?php echo $total_cabo_sophieu; ?> cán bộ)</a></li>
    <?php
    foreach ($thongke_quequan as $quequan => $soluong) {
        $menu_link_name = "quequan_" . urlencode($quequan);
        echo "<li><a href='tv_danhmucthitrandaingai.php?quequan=".urlencode($quequan)."' class='menu-link' id='$menu_link_name'>$quequan ($soluong cán bộ)</a></li>";
    }
    ?>
  </ul>
</div>
...
<div id="tinhtrang" class="center hidden">
  ...
  <ul>
    <li><a href='tv_danhmucthitrandaingai.php?tinhtrang=all' class="menu-link">Tất cả (<?php echo $num_row; ?> nhân viên)</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?tinhtrang=Đang hoạt động' class="menu-link">Đang hoạt động</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?tinhtrang=Miễn nhiệm' class="menu-link">Miễn nhiệm</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?tinhtrang=Bãi nhiệm' class="menu-link">Bãi nhiệm</a></li>
  </ul>
</div>
...
<div id="dantoc" class="center hidden">
  ...
  <ul>
    <li><a href='tv_danhmucthitrandaingai.php?dantoc=all' class="menu-link">Tất cả (<?php echo $num_row; ?> cán bộ)</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?dantoc=Kinh' class="menu-link">Kinh</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?dantoc=Hoa' class="menu-link">Hoa</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?dantoc=Khmer' class="menu-link">Khmer</a></li>
...
<div id="gioitinh" class="center hidden">
  ...
  <ul>
    <li><a href='tv_danhmucthitrandaingai.php?gioitinh=all' class="menu-link">Tất cả (<?php echo $num_row; ?> cán bộ)</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?gioitinh=Nam' class="menu-link">Nam</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?gioitinh=Nữ' class="menu-link">Nữ</a></li>
  </ul>
</div>
...
<div id="tongiao" class="center hidden">
  ...
  <ul>
    <li><a href='tv_danhmucthitrandaingai.php?tongiao=all' class="menu-link">Tất cả (<?php echo $num_row; ?> cán bộ)</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?tongiao=Phật giáo' class="menu-link">Phật giáo</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?tongiao=Cao Đài' class="menu-link">Cao Đài</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?tongiao=Công giáo' class="menu-link">Công giáo</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?tongiao=Tin lành' class="menu-link">Tin lành</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?tongiao=Thiên chúa' class="menu-link">Thiên chúa</a></li>
    <!-- Thêm các tôn giáo khác tương tự như trên -->
    <li><a href='tv_danhmucthitrandaingai.php?tongiao=Không tôn giáo' class="menu-link">Không tôn giáo</a></li>
  </ul>
</div>
...
<div id="chuyenmonnghiepvu" class="center hidden">
  ...
  <ul>
    <li><a href='tv_danhmucthitrandaingai.php?chuyenmon=all' class="menu-link">Tất cả (<?php echo $num_row; ?> cán bộ)</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?chuyenmon=Thạc sĩ' class="menu-link">Thạc sĩ</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?chuyenmon=Đại học' class="menu-link">Đại học</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?chuyenmon=Cao Đẳng' class="menu-link">Cao Đẳng</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?chuyenmon=Trung Cấp' class="menu-link">Trung Cấp</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?chuyenmon=Phổ thông' class="menu-link">Phổ thông</a></li>
...
<div id="tuoi" class="center hidden">
  ...
  <ul>
    <li><a href='tv_danhmucthitrandaingai.php?tuoi=18_70' class="menu-link">Tất cả từ 18 đến 70 tuổi</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?tuoi=20_35' class="menu-link">Từ 20 đến 35 tuổi</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?tuoi=35_45' class="menu-link">Từ trên 35 đến dưới 45 tuổi</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?tuoi=45_62' class="menu-link">Từ trên 45 đến dưới 62 tuổi</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?tuoi=62_tren' class="menu-link">Từ 62 tuổi trở lên</a></li>
  </ul>
</div>
...
<div id="lyluanchinhtri" class="center hidden">
  ...
  <ul>
    <li><a href='tv_danhmucthitrandaingai.php?lyluanchinhtri=all' class="menu-link">Tất cả</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?lyluanchinhtri=Cao cấp' class="menu-link">Cao cấp</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?lyluanchinhtri=Trung cấp' class="menu-link">Trung cấp</a></li>
...
<div id="ngoaingu" class="center hidden">
  ...
  <ul>
    <li><a href='tv_danhmucthitrandaingai.php?ngoaingu=all' class="menu-link">Tất cả (<?php echo $num_row; ?> cán bộ)</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?ngoaingu=Tiếng Anh' class="menu-link">Tiếng Anh</a></li>
    <li><a href='tv_danhmucthitrandaingai.php?ngoaingu=Tiếng Đức' class="menu-link">Tiếng Đức</a></li>
...
<table width="100%" border="1">
    ...
    <td height="80" class="dynamic-text">
      <a href="tv_chitietthitrandaingai.php?MaCB=<?php echo $i[0]; ?>"><?php echo $i[0];?></a>
    </td>
    <td height="80" class="dynamic-text">
      <a href="tv_chitietthitrandaingai.php?MaCB=<?php echo $i[0]; ?>"><?php echo $i[1];?></a>
    </td>
    <td><?php echo $i[2];?></td>
    <td><?php echo $i[3];?></td>
    <td><?php echo $i[4];?></td>
    ...
    <td><?php echo $i[6];?></td>
    <td height="80" class="dynamic-text">
      <a href="tv_chitietthitrandaingai.php?MaCB=<?php echo $i[0]; ?>"><?php echo $i[7];?></a>
    <td><?php echo $i[8];?></td>
    <td><?php echo $i[9];?></td>
    <td><?php echo $i[10];?></td>
    <td><?php echo $i[11];?></td>
    ...
    <td width="8%">
        <?php
            ...
            echo '<a href="tv_edit1thitrandaingai.php?MaCB='.$i[0].'">Sửa</a>';
            echo ' | ';
            echo '<a href="sp_process_deletethitrandaingai.php?MaCB='.$i[0].'" onclick="return confirm(\'Bạn có muốn xóa hay không\');">Xóa</a>';
        ?>     
    </td>
</tr>
        <?php
